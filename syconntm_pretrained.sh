            ...
            do
                ...
                do
                    ...
                    do
                        for t in "${num_topics[@]}"
                        do
                        python -m src.main --data_name $data_set_name --model_name $model_name --preprocess $pre --device $device --save_dir $save_path --context_size $context --context_type $context_t --load_lm_path $load_lm_path --lambda_ $l --num_topics $t --top_n $top_n
                        done
                    done
                done
            done

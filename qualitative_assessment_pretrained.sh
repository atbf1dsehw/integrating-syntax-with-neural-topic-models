...
load_lm_path="/raid/work/username/final_results/lm_results"
topics=10
num_syn_topics=10
top_n=5
        ...
        do
            ...
            do
                ...
                do
                    for l in "${lambda[@]}"
                    do
                        python -m src.main --data_name $data_set_name --model_name $model_name --preprocess $pre --device $device --save_dir $save_path --context_size $context --context_type $context_t --load_lm_path $load_lm_path --lambda_ $l --num_topics $topics --num_syn_topics $num_syn_topics --top_n $top_n
                    done
                done
            done
        done
